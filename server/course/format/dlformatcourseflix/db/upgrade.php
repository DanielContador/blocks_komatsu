 ...
 * @return bool result
 */
function xmldb_format_dlformatcourseflix_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2017111301) {
        ...
        (SELECT id FROM {course} WHERE format=?)", ['dlformatcourseflix']);

        upgrade_plugin_savepoint(true, 2017111301, 'format', 'dlformatcourseflix');
    }
