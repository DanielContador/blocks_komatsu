...
$PAGE->set_url($url);
$PAGE->requires->css(new moodle_url('/theme/dlcourseflix/style/mod_quiz/style.css'));
...
$PAGE->set_title(get_string('review_title', 'quiz', $attemptobj->get_quiz_name()));
...
//$output = $PAGE->get_renderer('theme_dlcourseflix', 'mod_quiz');
