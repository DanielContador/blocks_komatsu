...
$PAGE->set_url('/user/calendar.php', ['id' => $userid]);

[$user, $course] = useredit_setup_preference_page($userid, SITEID);
...
// Create form.
$calendarform = new core_user\form\calendar_form(null, ['userid' => $user->id]);
