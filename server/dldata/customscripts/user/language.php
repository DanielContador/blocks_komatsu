...
$PAGE->set_url('/user/language.php', ['id' => $userid, 'course' => $courseid]);

[$user, $course] = useredit_setup_preference_page($userid, $courseid, 'language');

// Create form.
$languageform = new user_edit_language_form(null, ['userid' => $user->id]);
