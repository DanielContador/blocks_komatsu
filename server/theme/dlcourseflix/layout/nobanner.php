...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/style/nobanner.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/style/dlforms.css">
    <!--<link rel="stylesheet" type="text/css" href="<?php /*echo $CFG->wwwroot; */?>/theme/dlcourseflix/style/mod_quiz/style.css">-->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/javascript/scorm.js"; ?></script>
</head>
<body <?php echo $OUTPUT->body_attributes(['dl-dark-mode', 'menuflex','dl-form']); ?>>
...
$PAGE->requires->js_call_amd('theme_dlcourseflix/navblock', 'init');
...
<div id="page" class="container-fluid">
    <div id="page-content" class="row">
        ...
        <div class="row contenido">
            <div id="region-main" class="nobanner">
            ...
            <!-- Right side block region (side-post) -->
