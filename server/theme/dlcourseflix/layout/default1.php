...
$search_box = isset($PAGE->layout_options['search_box']) && $PAGE->layout_options['search_box']?$PAGE->layout_options['search_box']:'';
$hasbreadcrumb = isset($PAGE->layout_options['breadcrumb']) && $PAGE->layout_options['breadcrumb'];
echo $themerenderer->dl_masthead1($hasguestlangmenu, $nocustommenu, $search_box);
