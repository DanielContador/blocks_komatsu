...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/style/catalog.css">
</head>
...
echo $themerenderer->dl_masthead2($hasguestlangmenu, $nocustommenu, $search_box);
?>
