...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/style/internal.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/javascript/internal.js"; ?></script>
</head>
<body <?php echo $OUTPUT->body_attributes(['dl-dark-mode', 'catalog' , 'menuflex', 'fixed-menu-top']); ?>>
...
echo $themerenderer->dl_masthead2($hasguestlangmenu, $nocustommenu);
