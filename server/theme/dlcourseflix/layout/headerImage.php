...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/dlcourseflix/style/headerImage.css">
</head>
...
$search_box =
    isset($PAGE->layout_options['search_box']) && $PAGE->layout_options['search_box'] ? $PAGE->layout_options['search_box'] : '';
